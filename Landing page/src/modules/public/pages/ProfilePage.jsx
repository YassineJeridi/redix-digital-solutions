...
const BG_ICONS = [
  ...
  {
    src: "/assets/icons/TunisianGuy.png",
    size: 42,
    top: "82%",
    left: "10%",
    delay: "3s",
  ...
  return (
    <div className={styles.page}>
      ...
      <a
        ...
        href="https://www.redixdigitalsolutions.com"
        target="_blank"
        rel="noopener noreferrer"
      >
        <img
          src="/assets/logos/redix.png"
          alt="Redix"
          className={styles.brandLogo}
        />
        <span className={styles.brandName}>
          Redix<span> Digital Solutions</span>
        </span>
      </a>
        ...
        <div className={styles.contacts}>
          ...
          {website && (
            ...
            >
              ...
              <span className={styles.btnBody}>
                <span className={styles.btnLabel}>Website</span>
