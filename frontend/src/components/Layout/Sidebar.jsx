...
const menuSections = [
  {
    label: "MAIN",
    collapsible: false,
    items: [{ text: "Overview", icon: <MdDashboard />, path: "/overview" }],
  },
  {
    ...
    items: [
      ...
      { text: "Clients", icon: <MdPeople />, path: "/clients" },
      {
        text: "Invoice Status",
        icon: <MdFactCheck />,
        path: "/work/invoice-status",
      },
      { text: "Receipt", icon: <MdArticle />, path: "/work/receipt" },
    ],
  },
  {
    ...
    items: [
      ...
      { text: "Ads & USDT", icon: <MdCampaign />, path: "/ads" },
    ],
  },
  {
    label: "TEAM & INSIGHTS",
  ...
  return (
    <>
      ...
      >
        ...
        <nav className={styles.nav}>
          {menuSections.map((section) => {
            const isSectionCollapsed =
              section.collapsible && collapsedSections[section.label];
            return (
                ...
                {!collapsed &&
                  (section.collapsible ? (
                    ...
                    >
                      ...
                      {isSectionCollapsed ? (
                        <MdExpandMore className={styles.chevron} />
                      ) : (
                        <MdExpandLess className={styles.chevron} />
                      )}
                    </button>
                  ) : (
        ...
        <div
          className={`${styles.sidebarFooter} ${collapsed ? styles.sidebarFooterCollapsed : ""}`}
        >
          {user && !collapsed && (
